...
export const BOARD = [
    ...
    { id: 5,  type: 'station',  name: 'Terminal Valongo',  price: 2000, rent: [250, 500, 1000, 2000] },
    ...
    { id: 12, type: 'station',  name: 'Balsa Santos-Guarujá', price: 1500, rent: [50, 100] },
    ...
    { id: 15, type: 'station',  name: 'VLT Estação Ana Costa', price: 2000, rent: [250, 500, 1000, 2000] },
    ...
    { id: 25, type: 'station',  name: 'Rodoviária de Santos', price: 2000, rent: [250, 500, 1000, 2000] },
    ...
    { id: 28, type: 'station',  name: 'Companhia Docas (CODESP)', price: 1500, rent: [50, 100] },
    ...
    { id: 35, type: 'station',  name: 'Porto de Santos',   price: 2000, rent: [250, 500, 1000, 2000] },
